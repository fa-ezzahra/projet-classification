...
class GabaritsDetector:
    ...
    def match_gabarit(self, features: Dict[str, float], document_type: str) -> float:
        ...
        elif document_type in ["facture_electricite", "facture_eau"]:
        ...
        elif document_type == "document_employeur":
            # Document employeur: signature + texte structuré
            score += 0.4 * features['signature_confidence']
            score += 0.3 if features['text_density'] > 0.3 else 0.0
            score += 0.3 if features['has_table'] else 0.15
